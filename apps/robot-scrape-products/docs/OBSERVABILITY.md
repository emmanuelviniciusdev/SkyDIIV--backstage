...
Git-owned Grafana Cloud dashboards live in [`observability/grafana/README.md`](../../../observability/grafana/README.md). **SkyDIIV — Overview** queries this robot's OTLP metrics. Git is the source of truth; UI-only edits are overwritten on deploy.
